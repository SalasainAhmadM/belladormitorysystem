		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-md-offset-3" style="margin-top:4%">
					...
					<h1 class="text-center text-bold text-light mt-4x text-border">
						Bella Dormitory Management System
					</h1>
					...
					<div class="well row pt-2x pb-3x bk-light">
						<div class="col-md-8 col-md-offset-2">
							...
							<form action="" class="mt" method="post">
								...
								<a href="../login.php" class="btn btn-secondary btn-block mt-2">Back to User Login</a>
							</form>
						</div>
					</div>
				</div>
