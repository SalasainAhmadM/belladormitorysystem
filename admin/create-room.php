...
if ($_POST['submit']) {
	...
	$stmt_count->execute();
	$stmt_count->bind_result($room_count);
	$stmt_count->fetch();
	$stmt_count->close();

	if ($room_count >= 15) {
		echo "<script>alert('Room limit reached! Cannot add more than 15 rooms.');</script>";
	} else {
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<?php if (isset($_POST['submit'])) { ?>
											<p style="color: red">Room Created Successfully!</p>
										<?php } ?>
										<form method="post" class="form-horizontal">

											<div class="hr-dashed"></div>
											<div class="form-group">
												<label class="col-sm-2 control-label">Select Bed </label>
												<div class="col-sm-8">
